            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="px-3">
                        <form class="form">
                            <div class="form-body">
                                <h4 class="form-section"> Add New Blue Collar Staff</h4>
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="husband_cnic" name="husband_cnic" >
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="phone_number">Pay</label>
                                            <input type="text" class="form-control" id="phone_number" name="phone_number" >
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="emergency_contact">Address </label>
                                            <input type="text" class="form-control" id="emergency_contact" name="emergency_contact" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
