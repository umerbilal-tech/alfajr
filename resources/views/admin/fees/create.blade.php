        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="px-3">
                        <form class="form" action="{{route('admin.fee.store')}}" method="POST">
                            @csrf
                            <div class="form-body">
                                <h4 class="form-section"> Add Fees</h4>
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required name="total_fee" id="total_fee">
                                        </div>
                                    </div>
                                </div>
