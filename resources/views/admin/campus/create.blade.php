        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="px-3">
                        <form class="form" action="{{route('admin.campus.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <h4 class="form-section"> Add New Campus</h4>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="campus_name">Campus Name</label>
                                            <input type="text" id="campus_name" class="form-control" required name="campus_name">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="start_date" class="form-control" required name="start_date">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="cover_image" class="form-control" name="cover_image" required>
                                        </div>
                                    </div>
                                </div>
